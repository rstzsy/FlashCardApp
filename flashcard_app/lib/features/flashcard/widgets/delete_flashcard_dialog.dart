...
class DeleteFlashcardDialog extends StatelessWidget {
  ...
  const DeleteFlashcardDialog({super.key, required this.onConfirm});
  ...
  static void show(BuildContext context, {required VoidCallback onConfirm}) {
    showGeneralDialog(
      ...
      pageBuilder: (_, __, ___) => DeleteFlashcardDialog(onConfirm: onConfirm),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            // Cừu buồn
            Image.asset(
              'assets/character/worry.png', // ← đổi thành ảnh cừu buồn riêng nếu bạn có file khác
              width: 100,
              height: 100,
              fit: BoxFit.contain,
            ),
            ...
            // Message
            const Text(
              'This flashcard set will be gone for good.',
